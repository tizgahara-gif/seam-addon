...
REQUIRED_TOKENS: dict[str, tuple[str, ...]] = {
    ...
    "auto_seam_uv_equalizer/__init__.py": (
        "operators.AUTOSEAMUV_OT_select_edge_loop_candidates",
    ),
    "auto_seam_uv_equalizer/operators.py": (
        ...
        "class AUTOSEAMUV_OT_select_edge_loop_candidates",
    ...
    "auto_seam_uv_equalizer/ui.py": (
        ...
        'actions_box.operator("autoseamuv.select_edge_loop_candidates", text="Select Edge Loop Candidates"',
        "grid_fit_to_cell",
        "grid_cell_margin",
        "grid_cell_fill_ratio",
        "edge_loop_min_length",
