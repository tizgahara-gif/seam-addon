...
_JA_JP = {
    ...
    "Shared Atlas": "共有アトラス",
    "Packing": "パッキング",
    "Allow 90° Island Rotation": "90°アイランド回転を許可",
    "Allows UV islands to rotate by 90 degrees during weighted packing when doing so improves placement efficiency. Island scale and importance are preserved": "Weighted Packing時に配置効率が向上する場合、UVアイランドを90°単位で回転できるようにします。アイランドの重要度と相対スケールは維持されます",
