...
class AUTOSEAMUV_PT_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        loop_box = layout.box()
        loop_box.label(text="Edge Loop Candidates")
        loop_box.prop(settings, "edge_loop_min_length")
        loop_box.prop(settings, "closed_loops_only")
        ...
        actions_box.operator("autoseamuv.select_edge_loop_candidates", text="Select Edge Loop Candidates", icon="EDGESEL")
